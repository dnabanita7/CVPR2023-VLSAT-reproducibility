...
class SGGpoint(BaseModel):
    ...
    def __init__(self, config, num_obj_class, num_rel_class):
        ...
        self.init_weight(obj_label_path='data/3DSSG_subset/classes.txt', \
                         rel_label_path='data/3DSSG_subset/relations.txt', \
                         adapter_path='clip_adapter/checkpoint/origin_mean.pth')
